...
public class Translit {
    private static final String ENTITY_NAME_NOT_ALLOWED_CHARACTERS = "[^0-9A-Za-z\\-\\_]+";
    ...
    public static String generateTranslitName(String name) {
        return Translit.toTranslit(name).replaceAll("\\s+", "-")
                .replaceAll(ENTITY_NAME_NOT_ALLOWED_CHARACTERS, "").toLowerCase();
    }
}
